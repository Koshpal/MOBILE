...
struct IncomingTransactionsView: View {
                    ...
                    ScrollView {
                        VStack(spacing: 16) {
                            ...
                            HStack(alignment: VerticalAlignment.center) {
                                ...
                                Text("+ \(formatAmount(bridge.incomeThisMonth))")
                                    .font(.system(size: 20, weight: .bold))
                                    .foregroundColor(KoshpalTheme.accentBlue)
                            }
                            ...
                            // Transactions List
                            if bridge.incomingTransactions.isEmpty {
                                VStack(spacing: 8) {
                                ...
                                LazyVStack(spacing: 12) {
                                    ForEach(bridge.incomingTransactions, id: \.id) { transaction in
                                        Button(action: {
...
struct IncomeTransactionRow: View {
    ...
    var partyName: String {
        let name = transaction.senderName
            ...
            HStack {
                HStack(spacing: 4) {
                    Text("+")
                        ...
                        .foregroundColor(KoshpalTheme.textGreen)
                ...
                Text((transaction.category ?? "INCOME").uppercased())
