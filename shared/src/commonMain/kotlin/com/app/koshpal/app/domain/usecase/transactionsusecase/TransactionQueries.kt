...
data class TransactionQueries(
    ...
    val saveLocalTransactions: SaveLocalTransactionsUseCase,
...
class SaveLocalTransactionsUseCase(private val repository: TransactionsRepo) {
    suspend operator fun invoke(transactions: Transactions) {
        repository.saveLocalTransactions(transactions)
    }
}
