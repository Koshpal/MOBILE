...
class ProfileCoordinator(
    ...
    fun updateAutoSiriTransactions(enabled: Boolean) {
        scope.launch { userPreferences.updateAutoSiriTransactions(enabled) }
    }

    fun updateAutoMessageTransactions(enabled: Boolean) {
        scope.launch { userPreferences.updateAutoMessageTransactions(enabled) }
    }
