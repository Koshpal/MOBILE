...
interface BudgetRepo {
    ...
    suspend fun getRemoteBudgets(token: String): Result<List<Budget>, NetworkError>
    ...
    suspend fun deleteRemoteBudget(token: String, budgetId: String): Result<CommonResponse, NetworkError>
}
