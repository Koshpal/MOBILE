...
interface GoalRepo {
    ...
    suspend fun getRemoteGoals(token: String): Result<List<Goal>, NetworkError>
    ...
    suspend fun deleteRemoteGoal(token: String, goalId: String): Result<CommonResponse, NetworkError>
}
